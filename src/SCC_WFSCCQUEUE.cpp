/*
* Wait free queue to collect SCC
*/
#include <algorithm>
#include <atomic>
#include <chrono>
...
int main(int argc, char const *argv[]) {
    ...
    AtomicEnQueue<std::vector<int>> sccs; //output list
    ...
    // for (QueueNode<std::vector<int>> *sccelem=sccs.getFlushedFirstNode(); sccelem!=nullptr; sccelem=sccelem->next) { //print found sccs
    //     for (const auto& inner_elem : (sccelem->v)) {
    //         std::cout<<inner_elem<<" ";
    //     }
    //     std::cout<<"\n";
    // }
